...
Do While Not ready And waited < 60
    ...
    ' CALIBRATION: Polls port 5001 to track the secondary trading instance socket maps
    http.Open "GET", "http://localhost:5001/ping", False
...
' FIX: WshShell.Run removed completely to guarantee single-tab launch state integrity.
